...
\tindex{decision procedure}{예-아니오 자동 판정기}
...
\tindex{delayed evaluation}{최대한 미루어 계산하기}
...
\tindex{function application}{함수 사용하기}
...
\tindex{network}{넷트웍}
\tindex{node}{노드}
\tindex{non-deterministic}{한가지로 정하지 않는}
...
\tindex{static analysis}{정적 프로그램 분석}
...
\tindex{total function}{모든게 정의된 함수}
\tindex{tree}{가지구조}
\tindex{tree}{나무구조}
\tindex{tuple}{짝}
\tindex{type}{타입}
...
\tindex{type scheme generalization}{타입 틀 적용시키기}
\tindex{type scheme generalization}{타입 틀 적용}
\tindex{type scheme}{타입 틀}
\tindex{type structure enrichment}{타입 구조의 적용}
\tindex{type structure}{타입 구조}
\tindex{type variable}{타입 변수}
\tindex{type}{타입}
\tindex{typing rule}{타입유추하는 규칙}
\tindex{typing rule}{타입결정하는 규칙}
