...
\tindex{curried function}{여러인자를 야금야금 받을 수 있는 함수}
...
\tindex{scaffolding code}{테스트 거푸집 코드}
\tindex{scheme}{틀}
\tindex{scope}{유효범위}
...
\tindex{static scope}{미리 결정된 이름의 유효 범위}
...
\tindex{type scheme instantiation}{타입 틀 유추}
