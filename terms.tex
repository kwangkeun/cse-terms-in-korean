...
\tindex{abstract class}{껍데기뿐인 클래스}
\tindex{abstract method}{껍데기뿐인 함수}
\tindex{abstract class}{허물뿐인 클래스}
\tindex{abstract method}{허물뿐인 함수}
...
%F
\tindex{first-class function}{특별하지않게 취급되는 함수}
